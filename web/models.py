...
class Usuario(AbstractUser):
    ...
    correo_electronico = models.EmailField(unique=True, default='email@correo.cl')
...
class Inmueble(models.Model):
    ...
    m2_terreno = models.DecimalField(max_digits=10, decimal_places=0)
...
class SolicitudArriendo(models.Model):
    ...
    estado = models.CharField(max_length=15, choices=TIPO_ESTADO_CHOICES, default='pendiente')
